...
public class QRCode {
     ...
     * This is the location of the QR code
     * @param photos
     * This is the list of photos of the QR code
     * @param comments
     * This is the list of comments on the QR code
     * @param players
     * This is the list of players that have scanned the QR code
     */
    public QRCode(String hash, String name, Image visualRepresentation, Integer score, Location loc, ArrayList<Photo> photos, ArrayList<Comment> comments, ArrayList<Player> players) {
        this.hash = hash;
        this.name = name;
