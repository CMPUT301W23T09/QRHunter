...
public class Location {
   ...
   *
   * @param latitude This is the latitude coordinate of the location
   * @param longitude This is the longitude coordinate of the location
   */
   ...
   *
   * @return Return the latitude coordinate of the location
   */
   ...
   *
   * @return Return the longitude coordinate of the location
   */
   ...
   *
   * @param latitude This is the latitude coordinate to set the location to
   */
   ...
   *
   * @param longitude This is the longitude coordinate to set the location to
   */
